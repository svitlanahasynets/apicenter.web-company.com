<div class="m-portlet m-portlet--bordered m-portlet--unair">
	...
	<?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/projectcontrol.log')): ?>
		<h5 class="m-portlet__head-text" style="padding: 10px;"> Project Control metric data *BETA* <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','projectcontrol')" style="float: right;"> Reset Control Log </button> </h5>
		<div class="m-portlet__body">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="8">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/projectcontrol.log'); ?></textarea>
			</div>
		</div>
	<?php endif; ?>
	...
	<?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/exportorders.log')): ?>
		<h5 class="m-portlet__head-text" style="padding: 10px;"> Export orders  ( Total Exported orders <font color="green"> <?php echo $log_details['orders_success'];?> </font>  |  Generated errors <font color="red"> <?php echo $log_details['orders_error'];?> </font> ) <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','exportorders')" style="float: right;"> Reset orders Log </button> </h5>
		<div class="m-portlet__body">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
	...
	<?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/tracktrace.log')): ?>
		<h5 class="m-portlet__head-text" style="padding: 10px;"> Create Shipment </h5>
		<div class="m-portlet__body">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/tracktrace.log'); ?></textarea>
			</div>
		</div>
	<?php endif; ?>
    ...
    <?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/exact_buy_orders.log')): ?>
        <h5 class="m-portlet__head-text" style="padding: 10px;"> Imported Buy Orders   <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','exact_buy_orders')" style="float: right;"> Reset Imported Orders Log </button> </h5>
        <div class="m-portlet__body">
            <div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/exact_buy_orders.log'); ?></textarea>
            </div>
        </div>
    <?php endif; ?>

    <?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/exact_sell_orders.log')): ?>
        <h5 class="m-portlet__head-text" style="padding: 10px;"> Imported Sell Orders   <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','exact_sell_orders')" style="float: right;"> Reset Imported Orders Log </button> </h5>
        <div class="m-portlet__body">
            <div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/exact_sell_orders.log'); ?></textarea>
            </div>
        </div>
    <?php endif; ?>

    <?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/optiply_suppliers.log')): ?>
        <h5 class="m-portlet__head-text" style="padding: 10px;"> Imported Suppliers  <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','optiply_suppliers')" style="float: right;"> Reset Imported Suppliers Log </button> </h5>
        <div class="m-portlet__body">
            <div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/optiply_suppliers.log'); ?></textarea>
            </div>
        </div>
    <?php endif; ?>

    <?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/optiply_connection.log')): ?>
        <h5 class="m-portlet__head-text" style="padding: 10px;"> Optiply connection <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','optiply_connection')" style="float: right;"> Reset Optiply Log </button> </h5>
        <div class="m-portlet__body">
            <div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/optiply_connection.log'); ?></textarea>
            </div>
        </div>
    <?php endif; ?>
    
    
    <?php if(file_exists(DATA_DIRECTORY.'/log_files/'.$project['id'].'/reimport_orders.log')): ?>
    <h5 class="m-portlet__head-text" style="padding: 10px;"> Check buy orders <button class="btn btn-danger" onclick="deleteLog('<?php echo  $project_id ;?>','reimport_orders')" style="float: right;"> Reset Optiply Log </button> </h5>
    <div class="m-portlet__body">
        <div class="col-lg-12 col-md-12 col-sm-12">
				<textarea class="form-control log" id="m_clipboard_3" rows="6">
			<?php echo file_get_contents(DATA_DIRECTORY.'/log_files/'.$project['id'].'/reimport_orders.log'); ?></textarea>
        </div>
    </div>
    <?php endif; ?>
</div>
