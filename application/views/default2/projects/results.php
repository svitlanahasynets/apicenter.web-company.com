...
<?php foreach($projects as $project): ?>
	...
	?>
		<tr style="cursor: pointer;" class="<?php echo $tr_class;?>" onclick="App.navigateTo('<?php echo site_url('/projects/view/id/'.$project['id']);?>');">
			...
			<td title="<?php echo $controller->webshopaname($project['id'],'pim'); ?>" data-column="title"><?php echo $controller->webshopaname($project['id'],'pim'); ?></td>
			...
			<td title="<?php echo $controller->webshopaname($project['id'],'pos'); ?>" data-column="title"><?php echo $controller->webshopaname($project['id'],'pos'); ?></td>
