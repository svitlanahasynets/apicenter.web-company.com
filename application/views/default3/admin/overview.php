<admin-overview-component post-title="<?php echo translate('Admin overview') ?>"  inline-template>
	<component :is="layout">
		...
		<!-- <b-card class="main-card mb-4"> -->
			<div class="content">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					<input type="hidden" name="update_url" id="update_url" value="<?php echo site_url('/admin-overview'); ?>" />
					<div class="">
						<div class="row" style="">
							<div class="col-xl-12">
								<div class="m-portlet m-portlet--mobile card ">
									...
									<div class="m-portlet__body" style="padding: 2.2rem 1.2rem;">
										...
										<form id="message_form" action="<?php echo site_url('/admin-overview'); ?>">
											<div class="m-section">
																...
																<tbody>
																	...
																	<?php foreach($messages as $message): ?>
																		<?php
																			...
																			$fourth_index = intval(substr($binary_str, -4, 1));
																			$tr_bold_style = '';

																			if (!$fourth_index || strlen($binary_str) < 4) {
