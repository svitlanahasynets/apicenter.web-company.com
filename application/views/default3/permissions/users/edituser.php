...
?>
<admin-permissions-component post-title="<?php echo translate('Create user') ?>" inline-template>
	<component :is="layout">
		...
		<script type="text/javascript">
			...
			<?php foreach($projects as $project): ?>
				...
				<?php 
					$permission = $this->Permissions_model->check_permission_user('project', $project['id'], $user['user_id']); 
					$partner_ids_str = $this->Permissions_model->getPartnerIds(); 
				?>
				permissionData.push({ title: '<?php echo cut(str_replace("'", "\'", $project["title"]), 80); ?>', key: 'project-<?php echo $project['id']; ?>', id: '<?php echo $project['id']; ?>', type: 'project', typeTitle: '<?php echo translate("Project"); ?>', permission: '<?php echo $permission; ?>', children: project_children, folder: true, partner_ids_str: '<?php echo $partner_ids_str; ?>' });
			<?php endforeach; ?>
		</script>
										...
										<?php echo form_open_multipart('permissions/saveuseraction', $form_attributes);?>
											...
											<div class="m-portlet__body">
												...
												<div class="form-field form-group m-form__group row">
													...
													<div class="col-8">
														<?php echo form_dropdown('user_role', $user_role, $selected_user_role, 'class="form-control m-input m-input--air"'); ?>
													</div>
												</div>
														...
														<table id="permissions-table" class="data-table">
															<thead>
																<tr>
																	...
																	<th><?php echo translate('Partner ID'); ?></th>
																</tr>
															</thead>
															<tbody>
																<tr>
