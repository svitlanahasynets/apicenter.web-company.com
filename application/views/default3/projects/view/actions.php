...
<div class="project-actions">
	...
	<?php elseif($erpSystem == 'accountview'): ?>
		<a href="<?php echo site_url('accountview/index/project/'.$project_id);?>?reauthorize=1" class="action-icon">
			<span class="icon fa fa-sign-in"></span>
			<span class="icon-text"><?php echo translate('AccountView authorization'); ?></span>
		</a>
	<?php elseif($erpSystem == 'eaccounting'): ?>
		<a href="<?php echo site_url('eaccounting/index/project/'.$project_id);?>?reauthorize=1" class="action-icon">
			<span class="icon fa fa-sign-in"></span>
			<span class="icon-text"><?php echo translate('EAccounting authorization'); ?></span>
		</a>
	<?php endif; ?>
	<?php 
		if($erpSystem == 'exactonline'): 
			...
			if(!$project_settings || $project_settings['value']==''):
				...
				<?php endif; 
					...
					<?php endif;
					if($project_settings['value']=='magento2'):
							?>
							<a href="<?php echo site_url('exactonline/index/?project_id='.$project_id);?>" class="action-icon">
								<span class="icon fa fa-sign-in"></span>
								<span class="icon-text"><?php echo translate('Exact authorization'); ?></span>
					...
					<?php endif;
					if($project_settings['value']=='cscart'):
						?>
						<a href="<?php echo site_url('exactonline/index/?project_id='.$project_id);?>" class="action-icon">
							<span class="icon fa fa-sign-in"></span>
							<span class="icon-text"><?php echo translate('Exact authorization'); ?></span>
				    ...
				    <?php endif;
				    if($project_settings['value']=='optiply'):
						?>
						<a href="<?php echo site_url('exactonline/index/?project_id='.$project_id);?>" class="action-icon">
							<span class="icon fa fa-sign-in"></span>
							<span class="icon-text"><?php echo translate('Exact authorization'); ?></span>
