...
$connection_type = array(
	...
	'values' => array(
		...
		'9' => 'ERP systeem & Marketing system'
	)
);
...
$db_users = $this->db->get('admin_users')->result_array();
$contacts = array();
$contacts[] = translate('None');
foreach($db_users as $db_user){
	$user_id = $db_user['userID'];
	$contacts[$user_id] = $db_user['firstname'].' '.$db_user['lastname'].' ('.$db_user['username'].')';
}
$submit = array(
    'name'          => 'submit',
    'id'            => 'submit',
...
?>
<admin-projectslist-component post-title="<?php echo translate('Create a project') ?>" inline-template>
	<component :is="layout">
									...
									<div class="tab-content">
										...
										<?php echo form_open_multipart('projects/createaction', $form_attributes);?>
											<div class="m-portlet__body">
												...
												<div class="form-field form-field-erp_system form-group m-form__group row" data-dependencies='{"connection_type":"2,1"}'>
													<label for="erp_system" class="col-3 col-form-label">
														<span class="label"> 
												...
												<div class="form-field form-field-webshop form-group m-form__group row" data-dependencies='{"connection_type":"3,1"}'>
