<integration-pages-component post-title="<?php echo translate('Integration') ?>"  inline-template>
	<component :is="layout">
		<page-title :heading=heading :icon=icon></page-title>
			<div>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					<input type="hidden" name="update_url" id="update_url" value="<?php echo site_url('/integrations/getResponse'); ?>" />
																				...
																				<?php if ($this->Permissions_model->check_permission_user('create_project', 0) == 've') : ?>
																					<li class="m-nav__item">
																						<span class="m-nav__link-text"><span class="icon fa fa-plus-square"></span>
																							<?php echo anchor(site_url('/integrations/create'), translate('Create project')); ?>
																						</span>
																					</li>
																					<li class="m-nav__item">
																						<span class="m-nav__link-text"><span class="icon fa fa-check"></span>
																							<?php echo anchor(site_url('/integrations/manageFormFieldsOrders'), translate('Arrange Fields Order')); ?>
																						</span>
																					</li>
																				<?php endif; ?>
																			</ul>
