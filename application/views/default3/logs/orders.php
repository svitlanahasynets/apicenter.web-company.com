<admin-projectslist-component post-title="<?php echo translate('Orders') ?>"  inline-template>
	<component :is="layout">
							...
							<div class="col-xl-12">
								<div class="m-portlet m-portlet--mobile card ">
									...
									<div class="m-portlet__head">
										<div class="m-portlet__head-caption">
											<div class="m-portlet__head-title">
												<h3 class="m-portlet__head-text">
													<span style="font-family: Roboto,sans-serif;">Export Orders ( Total Exported Orders <span style="color: green"><?php echo $total_count; ?></span> | Generated Errors <span style="color: red"><?php echo $generated_error_count; ?></span> )</span>
												</h3>
											</div>
										</div>
										<div class="m-portlet__head-tools">
											<?php
												...
												$site_url = '/logs/index/orders' . $suffix;
									...
									<div class="m-portlet__body" style="padding: 2.2rem 1.2rem;">
										...
										<form id="log_content_form" action="<?php echo site_url('/logs/index/orders'); ?>">
