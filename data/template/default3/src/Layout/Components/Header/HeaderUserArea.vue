            ...
            <div class="widget-content p-0">
                <div class="widget-content-wrapper">
                        ...
                        <b-dropdown toggle-class="p-0 mr-2" menu-class="dropdown-menu-lg" variant="link" no-caret right>
                            <span slot="button-content">
                                <div class="icon-wrapper icon-wrapper-alt rounded-circle">
                                    <img width="42" class="rounded-circle" :src="this.$user.profilepicture" alt="">
                                </div>
                            </span>
                          ...
                          <div class="dropdown-menu-header">
                                    ...
                                    <div class="menu-header-content text-left">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">{{ this.$user.fullname }}</div>
                            ...
                            <div class="scroll-area-xs" style="height: auto; padding: 10px 0;">
                                <VuePerfectScrollbar class="scrollbar-container" v-once>
                                    <ul class="nav flex-column">
                                        <li class="nav-item"><a href="/myaccount" class="nav-link">{{ $t('My account') }}</a></li>
                                        <li class="nav-item"><a href="/index.php/whmcsauth" class="nav-link">{{ $t('Subscriptions') }}</a></li>
                                        <li class="nav-item"><a href="/index.php/whmcsauth/submitticket" class="nav-link">{{ $t('Support') }}</a></li>
                                    </ul>
                                </VuePerfectScrollbar>
                            </div>
                    ...
                    <div class="widget-content-left  ml-3 header-user-info">
                        <div class="widget-heading">{{ this.$user.username }}</div>
                        <div class="widget-subheading">{{ this.$user.fullname }}</div>
                    </div>
